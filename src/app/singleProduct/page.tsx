...
const page = () => {
  return (
    <main className=''>
        ...
        {/* section----1...................................................... */}
        <section className='flex w-full   md:w-[1363px] md:h-[100px] top-[114px] border border-[#9F9F9F]  items-center gap-9'>
            <div className='w-[82px] h-[24px] top-[152px] left-[99px] flex mx-10 gap-2'>
               <Link href={'/'} > <p className='w-[48px] h-[24px] top-[152] font-["Poppins"] font-normal  text-[16px] leading-[24px] text-[#9F9F9F]'>Home</p></Link>
                <span className='pt-1'> <IoIosArrowForward /> </span>
                <Link href={'/shop'} > <p className='w-[48px] h-[24px] top-[152] font-["Poppins"] font-normal  text-[16px] leading-[24px] text-[#9F9F9F]'>Shop</p></Link>
                <span className='pt-1'> <IoIosArrowForward /> </span>
 ...
 {/* down side */}
        ...
        {/* section----3...................................................... */}
        <section className='flex w-full h-[800px] md:w-[1363px] md:h-[777px] top-[1031px] border-[1px] border-[#D9D9D9] flex-col md:items-center gap-10'>
    ...
    <div className='flex flex-col md:flex-row '>
        ...
        <div className='w-[115px] top-[2389px] left-[662px] border-[2px] border-black'></div>
        </div>
